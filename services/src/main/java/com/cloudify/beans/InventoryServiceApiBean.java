...
public class InventoryServiceApiBean {
    ...
    public List<Flight> listFlights(String origin, String destination, String departureDate, String returnDate) {
        // Return all hardcoded flights
        return List.of(
                new Flight("AB1234", "Delta Airlines", "LAX", "JFK", LocalDateTime.of(2025, 1, 10, 15, 30), LocalDateTime.of(2025, 1, 10, 20, 30), 299.99, "330", 50, "economy"),
                new Flight("CD5678", "American Airlines", "LAX", "ORD", LocalDateTime.of(2025, 1, 10, 15, 30), LocalDateTime.of(2025, 1, 10, 20, 30), 599.99, "225", 150, "business"),
                new Flight("EF9101", "United Airlines", "SFO", "MIA", LocalDateTime.of(2025, 1, 10, 15, 30), LocalDateTime.of(2025, 1, 10, 20, 30), 199.99, "320", 200, "economy"),
                new Flight("GH1122", "Delta Airlines", "ORD", "ATL", LocalDateTime.of(2025, 1, 10, 15, 30), LocalDateTime.of(2025, 1, 10, 20, 30), 999.99, "150", 180, "first"),
                new Flight("IJ3345", "British Airways", "JFK", "LHR", LocalDateTime.of(2025, 1, 10, 15, 30), LocalDateTime.of(2025, 1, 10, 20, 30), 499.99, "420", 120, "economy"),
                new Flight("KL5678", "Qantas Airways", "LAX", "SYD", LocalDateTime.of(2025, 1, 10, 15, 30), LocalDateTime.of(2025, 1, 10, 20, 30), 1499.99, "830", 70, "business"),
                new Flight("CD5679", "American Airlines", "LAX", "ORD", LocalDateTime.of(2025, 1, 10, 15, 30), LocalDateTime.of(2025, 1, 10, 20, 30), 680.99, "225", 150, "business"),
                new Flight("54", "Russian Airlines", "Moscow", "Vladivostok", LocalDateTime.of(2025, 1, 10, 15, 30), LocalDateTime.of(2025, 1, 10, 20, 30), 680.99, "225", 150, "business")
        );
    }
